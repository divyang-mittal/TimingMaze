    ...
    def perform_a_star_and_get_next_move(self, start, goals, exploration, current_percept):
        ...
        if path and len(path) > 1:
            ...
            if self.is_valid(move, current_percept):
                ...
                # print(f'wait chance : {wait_chance}')
                ...
                for action in actions:
                    ...
                    if self.is_valid(action, current_percept):
                        ...
                        # print('alt path about to be generated')
                        alt_path = self.a_star_search(adj_cell, goals, exploration)
                        # print('alt path generated')

                        if not alt_path or len(alt_path) <=1:
                            # print('alt path invalidly generated')
                            continue
